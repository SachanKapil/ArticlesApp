...
object AppUtils {
    ...
    fun getDateWithUpdatedFormat(
        ...
        try {
            return SimpleDateFormat(sourceFormat, Locale.US).parse(date)?.let { sourceDate ->
                SimpleDateFormat(targetFormat, Locale.US).format(sourceDate)
            } ?: ""
